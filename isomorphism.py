...
def is_isomorphic(n1,n2):
    ...
    return ((is_isomorphic(n1.left, n2.left)and
            is_isomorphic(n1.right, n2.right))or
            (is_isomorphic(n1.left, n2.right)and
...
print "Yes" if (is_isomorphic(n1, n2) == True) else "No"